...
public final class Machine {
	 ...
	 */
	public enum Prim {
		id, not, and, or, succ, pred, neg, add, sub, mult, div, mod, lt, le, ge, gt, eq, ne, eol, eof, get, put, geteol, puteol, getint, putint, alloc, dispose, newobj, newarr, arrayref, arrayupd, fieldref, fieldupd;
	}
	 ...
	 * These are operations like JUMPIF (1) 25[CB]
	 */
